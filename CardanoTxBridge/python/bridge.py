...
def swap(tmp, buyer_addr, wallet_skey_path, wallet_addr, script_addr, cost, datum_hash, plutus_script, seller_addr, policy_id, token_name, collateral):
...
if __name__ == "__main__":
    ...
    if result:
        swap(TMP, BUYER_ADDR, BRIDGE_SKEY_PATH, BRIDGE_ADDR, PLUTUS_SCRIPT_ADDR, PRICE, DATUM_HASH, PLUTUS_SCRIPT_PATH, SELLER_ADDR, ASSET_POLICY_ID, ASSET_NAME, COLLATERAL)
